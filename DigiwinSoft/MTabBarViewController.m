...
- (void)viewDidLoad {
    ...
    UITabBarItem* item2 = [[UITabBarItem alloc] initWithTitle:@"看現況" image:[UIImage imageNamed:@"tab_icon_2.png"] tag:1];
    ...
    UITabBarItem* item3 = [[UITabBarItem alloc] initWithTitle:@"行業攻略" image:[UIImage imageNamed:@"tab_icon_3.png"] tag:2];
    ...
    UITabBarItem* item4 = [[UITabBarItem alloc] initWithTitle:@"找對策" image:[UIImage imageNamed:@"tab_icon_4.png"] tag:3];
    ...
    UITabBarItem* item5 = [[UITabBarItem alloc] initWithTitle:@"我的任務" image:[UIImage imageNamed:@"tab_icon_5.png"] tag:4];
